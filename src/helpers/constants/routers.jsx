...
import { StudentClassCourseDetail, StudentClassCourseList, StudentCourseList, StudentFeedbackList, StudentWeeklySchedule } from "../../components/Pages/StudentPages"
...
export const instructorRouters = [
    ...
    },
    {
        ...
        render: () => <Navigate to='/schedule/weekly' />
    },
    {
        path: '/schedule',
        render: () => <Navigate to='/schedule/weekly' />
    ...
    {
        path: '/schedule/attendance/:id',//class_schedule_id
...
export const studentRouters = [
    ...
    {
        path: '/class',
        render: () => <PrivateRoute To={StudentClassCourseList} roles={['Student']} authRequire={true} ElseTo='/'></PrivateRoute>
    },
    {
        path: '/class/:id',
    ...
    {
        path: '/feedback',
        render: () => <PrivateRoute To={StudentFeedbackList} roles={['Student']} authRequire={true} ElseTo='/'></PrivateRoute>
    },
    ...commomRouters
]