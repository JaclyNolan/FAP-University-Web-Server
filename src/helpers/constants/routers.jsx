...
import { AttendanceReport, Classes, Feedback, MarkReport, News, StudentClassEnrollmentList, StudentCourseList, StudentCourseRegister, StudentWeeklySchedule } from "../../components/Pages/StudentPages"
...
export const studentRouters = [
    ...
    {
        path: '/class',
        render: () => <PrivateRoute To={StudentClassEnrollmentList} roles={['Student']} authRequire={true} ElseTo='/'></PrivateRoute>
    },
    {
